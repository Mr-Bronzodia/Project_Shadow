...
public class NewBehaviourScript : Editor
{
    private void OnSceneGUI()
    {
        ...
        Vector3 viewAngleUpA = aIVisionSense.DirFromAngleUp(aIVisionSense._viewAngle / 2, false);
        Vector3 viewAngleUpB = aIVisionSense.DirFromAngleUp(-aIVisionSense._viewAngle / 2, false);
